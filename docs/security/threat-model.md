...
- supplies an OpenBSD `rc.d` wrapper whose configuration test validates
  arguments, identity policy, and directory trust without creating state or
  requiring a running daemon's socket to disappear;
